...
public class DriveSubsestem {
     ...
     */
    public DriveSubsestem(HardwareMap hardwareMap, Telemetry opModeTelemetry) {
        // Initialize the hardware
        // The strings here must correspond to the names of the motors in your robot config
        leftFrontDrive = hardwareMap.dcMotor.get("front_left");
        leftBackDrive = hardwareMap.dcMotor.get("back_left");
        rightFrontDrive = hardwareMap.dcMotor.get("front_right");
        rightBackDrive = hardwareMap.dcMotor.get("back_right");
